...
def main():
    ...
    optimizer_message.info(f"Running optimizer for {article_count} article{'s' if article_count>1 else ''} and {package_count} individual package{'s' if package_count>1 else ''}...")
